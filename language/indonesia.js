...
exports.profile = (
  ...
  return `📛 Nama: ${username} (@${m.sender.split`@`[0]})${
    about ? "\n💌 Bio: " + about : ""
  }
👨‍❤️‍👨 Status: ${pasangan ? `Berpacaran @${pasangan.split`@`[0]}` : "-"}
#️⃣ Nomor: ${PhoneNumber(
    "+" + m.sender.replace("@s.whatsapp.net", "")
  ).getNumber("international")}
🔗 Link: https://wa.me/${m.sender.split`@`[0]}
🤷‍♂️ XP: Total ${exp} (${exp - min} / ${xp}) [ ${
    math <= 0 ? `Ready to *${prefix}levelup*` : `${math} XP left to levelup`
  } ]
🎚️ Level: ${level}
🎢 Role: ${role}
📊 Limit: ${limit}
...
exports.NoToStik = (prefix, command) => {
  return `Kirim/Reply Gambar/Video Dengan Caption ${
    prefix + command
...
exports.ToAud = (prefix, command) => {
  return `Kirim/Reply Video/Audio Yang Ingin Dijadikan Audio Dengan Caption ${
    prefix + command
  }`;
};
...
exports.ToVn = (prefix, command) => {
  return `Reply Video/Audio Yang Ingin Dijadikan VN Dengan Caption ${
    prefix + command
  }`;
};
exports.NoQouted = () => {
...
exports.OffNsfw = () => {
  return `Fitur nsfw belum di aktifkan sama Bagus sama Bagus`;
};
...
exports.StalkOrk = () => {
  return `\n_Stalking sosmed orang_`;
};
exports.Hoja = () => {
  return `\n_Mencari sesuatu yang penting_`;
};
exports.CovertWi = () => {
...
exports.wait = () => {
  return `_Wait a minute, data is being processed!_`;
};
exports.ok = () => {
  return `_✅ Sukses._`;
};
...
Hai
Kalian bisa mengirim pulsa ke saya
